...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        $mail->SMTPAuth = true;
        $mail->Port = 2525;
        $mail->Username = 'b6fda66c5570ba';
        $mail->Password = 'c914b42eb45bb4';

        $mail->setFrom('cuentas@uptaks.com');
    ...
    public function enviarInstrucciones() {
        ...
        $contenido .= "<p>Presiona aqui: <a href='http://localhost:3000/restablecer?token=" . $this->token . "'>Restaablecer Password</a></p>";
        $contenido .= "<p> Si tu no creaste esta cuenta, puedes ignorar este mensaje </p>";
        $contenido .= '</html>';
